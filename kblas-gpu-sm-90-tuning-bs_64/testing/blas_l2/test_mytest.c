...
int main(int argc, char** argv)
{
    ...
    printf(" Dimension     (Gflop/s)       (s)          (s)      (Gflop/s)       Error  \n");
    printf("-----------   ----------   ----------   ----------   ----------   ----------\n");
	...
	kblasElapsedTime = elapsedTime;
		...
		cudaMemcpy(ykblas, dy, vecsize_y * sizeof(float), cudaMemcpyDeviceToHost);
      	...
      	//printf("-----------   ----------   ----------   ----------   ----------   ----------\n");
    	printf("%-11d   %-10.2f   %-10.6f   %-10.6f   %-10.2f   %-10e;\n", m, cuda_perf, cudaElapsedTime, kblasElapsedTime, kblas_perf, error);
